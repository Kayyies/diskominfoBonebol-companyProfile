...
function BannerSection() {
  ...
  return (
    <div className="relative mb-40">
      <div
        className="relative my-20 bg-[#2563EB] py-1 dark:bg-[#202848] md:py-20 md:pt-[10px] lg:py-40 lg:pt-[71px]"
        style={{
      ...
      >
        <div className="container relative z-10 mx-auto my-10 px-6 md:my-0 md:mt-20 lg:px-30 2xl:px-48">
          <Banner />
        </div>
      </div>
    </div>
