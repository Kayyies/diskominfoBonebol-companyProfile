  ...
  return (
    <div className="flex flex-col gap-10">
      <div className="relative">
        ...
        <button
          onClick={prevSlide}
          className={`absolute left-0 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2 transform rounded-full bg-[#38BDF8] bg-opacity-50 p-2 shadow-lg transition-all duration-300 ease-in-out hover:bg-opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#38BDF8] dark:bg-white ${
                ...
                >
                  {slide.map((item, i) => (
                    <Link key={i} href={`/layanan/${item.id}`} passHref>
                      <div className="group card w-full cursor-pointer border-2 border-transparent bg-white shadow-md hover:border-blue-500 hover:shadow-md hover:transition-all hover:duration-75 dark:bg-darkSecondary dark:text-darkAccent">
        ...
        <button
          onClick={nextSlide}
          className={`absolute right-0 top-1/2 z-10 -translate-y-1/2 translate-x-1/2 transform rounded-full bg-[#38BDF8] bg-opacity-50 p-2 shadow-lg transition-all duration-300 ease-in-out hover:bg-opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#38BDF8] dark:bg-white ${
