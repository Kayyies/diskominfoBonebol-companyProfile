    ...
    return (
        <div className="bg-base-100">
            ...
            {isLoading ? (
                ...
                <div className="container mx-auto px-6 lg:px-30 2xl:px-48 pb-12">
                        ...
                        <div>
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="relative flex justify-between items-center mt-2">
                                    ...
                                    <button 
                                        onClick={prevSlide} 
                                        className="absolute start-0 btn btn-sm border-0 rounded-full bg-white shadow z-10 disabled:bg-white disabled:bg-opacity-50 hover:bg-white hover:shadow-lg"
                                    ...
                                    <div className="w-full grid grid-cols-4 gap-2 overflow-hidden transition-transform duration-300 ease-in-out">
                                        {dokumen?.images
                                    ...
                                    <button 
                                        onClick={nextSlide} 
                                        className="absolute end-0 btn btn-sm border-0 rounded-full disabled:bg-white disabled:bg-opacity-50 bg-white shadow z-10 hover:bg-white hover:shadow-lg"
                                        disabled={currentIndex + imagesPerSlide >= dokumen?.images.length}
                                    >
                                        &gt;
                                    </button>
